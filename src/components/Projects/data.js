const projectData = [
  ...
  How to setup and tweak Azure cloud for node js applications, how to use Azure file storage and cosmosdb.
      `,
      tagsArr: ['node.js', 'express.js', 'angular.js', 'mongodb', 'RETS'],
  },
  {
    title: 'RoyalOne CRM',
    summary: ` BA CRM designed for the internal organization to reduce manual work for your front line staff and improve time management by automating common tasks, queries and reports on customer interactions and critical business processes. Application is designed using MEAN Stack, also have features like Excel Reports generator.Import & Export of Data, graphical reports.`,
    description: ` A CRM designed for the internal organization to reduce manual work for your front line staff and improve time management by automating common tasks, queries and reports on customer interactions and critical business processes. 
      ...
      tagsArr: ['node.js', 'express.js', 'angular.js', 'mongodb'],
    },
  {
    ...
    tagsArr: ['node.js', 'express.js', 'react.js', 'twitter api'],
  },
  {
    ...
    tagsArr: ['c#', 'ASP.NET', 'SQL Server', 'jQuery', 'Asp.NET MVC', 'Telerik UI'],
  },
  {
    ...
    tagsArr: ['c#', 'ASP.NET', 'SQL Server', 'jQuery', 'jQuery Mobile'],
  },
  {
    ...
    tagsArr: ['c#', 'ASP.NET', 'SQL Server', 'jQuery', 'Dot Net Nuke'],
  },
]
